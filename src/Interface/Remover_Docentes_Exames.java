...
/**
 * Esta Classe serve para Remover um ou mais Vigilantes de um Exame.
 * @author Asus
 */
public class Remover_Docentes_Exames extends javax.swing.JInternalFrame {
    
    private final ArrayList<Exame> exames;
    private ArrayList<Docente> docentes;
    private int index;
    /**
     * Creates new form Remover_Docentes_Exames
     */
    public Remover_Docentes_Exames(ArrayList<Exame> exames) {
        initComponents();
        this.exames = exames;
        this.index = -1;
    }
    ...
    private void jComboBox_ExamesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox_ExamesActionPerformed
        ...
        if(jComboBox_Exames.getItemCount()<1){
            ...
            if (jComboBox_Exames.getSelectedIndex()!= index){
                ...
                this.docentes = exames.get(index).getVigilantes();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(indexs.length > 0){
            for (int i = indexs.length-1; i >= 0 ; i--) {
                exames.get(index).getVigilantes().remove(indexs[i]);
            }
            setVisible(false);
        ...
        }else jLabel_aviso.setText("Selecione algum Docente!");
